          ...
          <div id="edit-cyrcle-new-contact"></div>
            <div id="edit-content-rightside">
              <form onsubmit="saveNewContact()">
                ...
                <div id="save-delete-div">
                  <div id="cancel-btn-div" onclick="closeEdit()"><button type="button" id="cancel-btn-edit">Cancel</button><img id="cancel-icon" src="../img/cancel.png"></div>
                    <div id="save-btn-div"><button type="submit" id="save-btn-edit">Save</button><img id="check-icon" src="../img/check.png"></div>
                  </div>
                <div>
              </form>
          </div>
